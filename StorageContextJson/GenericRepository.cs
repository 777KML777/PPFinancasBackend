...
public abstract class GenericRepository : IGenericRepository/* <EntityData> */
{
    ...
    public IList<T> ReadAll<T>()
    {
        ...
        // var yu = Assembly.GetCallingAssembly().GetName().Name; // substituir por StorageContextJson
        // var ydfsa2 = Assembly.GetEntryAssembly().GetName().Name;// substituir por StorageContextJson
        ...
        // File.WriteAllText
        // (
        //     "/Users/klebermirandalima/Projetos/PPFinancasBackend/StorageContextJson/Reflex.cs",
        //      $"/*{file}*/"
        // );
